...
SECRET_KEY = 'django-insecure-4c^7$&ma+n(erj+i*z%&5o&w+n2(zj1kkb1p!6eouh59cc(w^a'
...
WSGI_APPLICATION = 'siteroupas.wsgi.application'
...
STATICFILES_DIRS = [
    ...
    BASE_DIR / "siteroupas_app/static",  
]
